...
for train_index, test_index in kf.split(X, y):
    ...
    for linkage_type in linkage_list :
        ...
        if linkage_type != 'average-group' :
            ...
            accuracy, dict = clustering_accuracy_score(np.asarray(y_test), np.asarray(result))
            if linkage_type == 'single' :
                sk_agglo_accuracy_single += accuracy
            elif linkage_type == 'complete' :
                sk_agglo_accuracy_complete += accuracy
            elif linkage_type == 'average' :
                sk_agglo_accuracy_average += accuracy
...
print ('Sklearn Agglomerative - Single\t', sk_agglo_accuracy_single/k)
print ('Sklearn Agglomerative - Complete ', sk_agglo_accuracy_complete/k)
print ('Sklearn Agglomerative - Average\t', sk_agglo_accuracy_average/k)
